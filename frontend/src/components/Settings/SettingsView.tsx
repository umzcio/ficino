...
import {
  ...
  Loader2, Check, ChevronDown, Download, HardDrive, Trash2
} from 'lucide-react'
...
function OfflineStorageSection({ workspaces, onDownload }: {
  workspaces?: Workspace[]
  ...
  return (
    <div>
      ...
      <div className="p-4 space-y-4 pb-20">
        ...
        {/* Offline & Storage */}
        <OfflineStorageSection workspaces={workspaces} onDownload={onDownloadWorkspace} />
